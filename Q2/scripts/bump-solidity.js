...
let contentMultiplier3_plonk = fs.readFileSync("./contracts/Multiplier3Verifier_plonk.sol", { encoding: 'utf-8' });
let bumpedMultiplier3_plonk = contentMultiplier3_plonk.replace(solidityRegex, 'pragma solidity ^0.8.0');
bumpedMultiplier3_plonk = bumpedMultiplier3_plonk.replace(verifierRegex, 'contract Multiplier3Verifier_plonk');

fs.writeFileSync("./contracts/Multiplier3Verifier_plonk.sol", bumpedMultiplier3_plonk);